...
<div class="flex-auto p-6">
    <form action="{{ url('/register_store_coach') }}" method="POST">
        @csrf
        <div class="mb-4">
        ...
        <p class="mt-4 mb-0 leading-normal text-sm">Already have an account? <a href="{{url ('/login_coach')}}" class="font-bold text-slate-700">Sign in</a></p>
    </form>
</div>
@endsection
