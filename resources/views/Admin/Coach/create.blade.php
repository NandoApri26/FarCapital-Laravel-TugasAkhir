                        ...
                        <div class="flex flex-wrap -mx-3">
                            ...
                            <div class="w-full max-w-full px-3  md:w-6/12 ">
                                ...
                                <div class="flex">
                                    ...
                                    <div class="flex items-center">
                                        <input checked id="Tidak Aktif" type="radio" value="TidakAktif" name="status" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
