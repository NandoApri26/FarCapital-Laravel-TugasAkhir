...
@section('title', 'PB. Mandiri Palembang || Update Level')
@section('content')
            ...
            <div class="relative flex flex-col min-w-0 break-words bg-white border-0 shadow-xl dark:bg-slate-850 dark:shadow-dark-xl rounded-2xl bg-clip-border">
                <div class="border-black/12.5 rounded-t-2xl border-b-0 border-solid p-6 pb-0">
                    <div class="flex text-center">
                        <p class="mb-0 dark:text-white/80 text-center">Update Table Level</p>
                    </div>
                </div>
                <form action="{{ url ('/Admin/Level/' .$level->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                        ...
                        <div class="flex flex-wrap -mx-3">
                            ...
                            <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                <div class="mb-4">
                                    ...
                                    <input type="number" name="lapangan" id="lapangan" value="{{ $level->lapangan }}" class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                </div>
                            </div>
